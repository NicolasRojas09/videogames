...
const Form = ({ login }) => {
    ...
    return(
        <div className={style.contenedor}>
            <button className={style.cerrarBtn} onClick={() => {navigate('/home')}}>✖</button>
            <form className={style.contenedorForm} onSubmit={handleSubmit}>
                <div className={style.sectores}>
                ...
                <div className={style.sectores}>
                    ...
                    <textarea type="text" name="description" value={gameData.description} onChange={handleChange}/>
                ...
                <div className={style.sectoresPlataf}>
                    <h5 className={style.h5Form}>Platforms</h5>
                    <div>
                ...
                <div className={style.sectoresPlataf}>
                    <h5 className={style.h5Form}>Genres</h5>
                    <div>
